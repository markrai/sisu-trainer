...
const SOUND_STYLE_DEFAULT = "binaural";
let soundStyle = SOUND_STYLE_DEFAULT;
(function loadSoundStyle() {
    try {
        const stored = localStorage.getItem(SOUND_STYLE_STORAGE_KEY);
        if (stored === "binaural" || stored === "whale" || stored === "none")
            soundStyle = stored;
    }
    catch {
        /* ignore */
...
export function setSoundStyle(value) {
    if (value !== "binaural" && value !== "whale" && value !== "none")
        return;
    soundStyle = value;
    try {
...
function scheduleEnvelope(atTime) {
...
function disconnectAndClear() {
    ...
    pulseCarrier === null || pulseCarrier === void 0 ? void 0 : pulseCarrier.stop();
    pulseCarrier = null;
    lowpass = null;
    pulseGain = null;
    panLfo === null || panLfo === void 0 ? void 0 : panLfo.stop();
    panLfo = null;
    binOscL === null || binOscL === void 0 ? void 0 : binOscL.stop();
    binOscR === null || binOscR === void 0 ? void 0 : binOscR.stop();
    binOscL = null;
    binOscR = null;
    binGainL = null;
    binGainR = null;
 ...
 */
export function restartCalmAudioIfRunning() {
    stopCalmAudio();
    if (getSoundStyle() !== "none")
        startCalmAudio();
}
