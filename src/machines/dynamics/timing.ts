...
import type { StoredDynamicsEntry } from "./types.js";
...
export function derivePersonalizedMachineTiming(
  entry: Pick<StoredDynamicsEntry, "workStartDelays" | "increaseDelays" | "decreaseDelays"> | undefined,
  phaseDurationSeconds: number
...
export function hasActiveTimingPersonalization(
  entry: Pick<StoredDynamicsEntry, "workStartDelays" | "increaseDelays" | "decreaseDelays">,
